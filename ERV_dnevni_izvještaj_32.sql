...
---------------
---------------
DECLARE @datum1 date= '2018-08-11';  
use rfind
select *
...
delete from pregledvremena where datum>='2018-06-22'
...
use rfind
delete from pregledvremena where datum>='2018-02-02'
...
--
--use rfind
delete from pregledvremena where datum>='2018-07-20' 
...
use rfind
delete from pregledvremena where datum>='2018-12-11'
...
use rfind
delete from pregledvremena where DATUM>='2018-09-10'
...
select *
from pregledvremena
where Datum>='2018-02-01'
--and radnomjesto='G.O.' 
order by rbroj,idradnika


use rfind
delete from pregledvremena where datum>='2019-5-21'                --and smjena!=1
...
select *
from pregledvremena
where idradnika in ( 73,1487)


update pregledvremena set idradnika=80 where idradnika=1373



select *
from pregledvremena
where idradnika=1650 and datum='2019-05-02'
order by datum desc


--delete from pregledvremena
--where idradnika=1650 and datum='2019-05-02' and rbroj=331
